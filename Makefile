...
#    Updated: 2024/08/20 08:51:44 by junsan           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSING	= parsing.c arg_parse.c parse_subshell.c parse_logical.c parse_pipe.c 		\
		...
		/utils/collect_data_until_subshell.c /utils/ensure_capacity.c				\
		/utils/handler_parse_subshell.c
...
EXECUTE = execute.c redir.c get_file_list.c dispatch_cmd.c launch_process_cmd.c 	\
		launch_process_pipe.c execution_pipe.c subshell.c nested_subshell.c			\
		...
		/utils/get_absolute_path.c /utils/get_path_type.c 							\
		/utils/find_cmd_in_path.c /utils/quotes_utils.c /utils/here_doc.c			\
